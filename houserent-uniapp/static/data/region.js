/**
 * 中国省市区三级联动数据
 * 包含31个省/直辖市/自治区的主要城市和区县
 */
export const regionData = [
	{ name: '北京市', cities: [{ name: '北京市', districts: ['东城区', '西城区', '朝阳区', '海淀区', '丰台区', '石景山区', '通州区', '顺义区', '房山区', '大兴区', '昌平区', '平谷区', '密云区', '怀柔区', '延庆区', '门头沟区'] }] },
	...
	{ name: '重庆市', cities: [{ name: '重庆市', districts: ['渝中区', '江北区', '南岸区', '九龙坡区', '沙坪坝区', '大渡口区', '巴南区', '北碚区', '渝北区', '万州区', '涪陵区', '长寿区', '永川区', '合川区', '江津区'] }] },
	{ name: '广东省', cities: [
		{ name: '广州市', districts: ['越秀区', '海珠区', '荔湾区', '天河区', '白云区', '黄埔区', '番禺区', '花都区', '南沙区', '增城区', '从化区'] },
		{ name: '深圳市', districts: ['福田区', '罗湖区', '南山区', '宝安区', '龙岗区', '龙华区', '坪山区', '光明区', '盐田区'] },
	...
	{ name: '江苏省', cities: [
		...
		{ name: '无锡市', districts: ['梁溪区', '滨湖区', '惠山区', '锡山区', '新吴区', '江阴市', '宜兴市'] },
		{ name: '徐州市', districts: ['鼓楼区', '云龙区', '贾汪区', '泉山区', '铜山区', '丰县', '沛县', '睢宁县', '新沂市', '邳州市'] },
		{ name: '常州市', districts: ['天宁区', '钟楼区', '新北区', '武进区', '金坛区', '溧阳市'] },
		{ name: '苏州市', districts: ['姑苏区', '虎丘区', '吴中区', '相城区', '吴江区', '昆山市', '太仓市', '常熟市', '张家港市'] },
		{ name: '南通市', districts: ['崇川区', '通州区', '海安市', '如东县', '启东市', '如皋市', '海门区'] },
	...
	{ name: '四川省', cities: [
		{ name: '成都市', districts: ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '双流区', '郫都区', '新津区', '都江堰市', '彭州市', '邛崃市', '崇州市', '简阳市'] },
	...
	{ name: '湖南省', cities: [
		{ name: '长沙市', districts: ['芙蓉区', '天心区', '岳麓区', '开福区', '雨花区', '望城区', '长沙县', '宁乡市', '浏阳市'] },
	...
	{ name: '河南省', cities: [
		...
		{ name: '洛阳市', districts: ['老城区', '西工区', '瀍河回族区', '涧西区', '洛龙区', '孟津区', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '偃师区'] },
	...
	{ name: '河北省', cities: [
		{ name: '石家庄市', districts: ['长安区', '桥西区', '新华区', '裕华区', '井陉矿区', '藁城区', '鹿泉区', '栾城区', '井陉县', '正定县', '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县', '无极县', '平山县', '元氏县', '赵县', '晋州市', '新乐市', '辛集市'] },
	...
	{ name: '安徽省', cities: [
		{ name: '合肥市', districts: ['瑶海区', '庐阳区', '蜀山区', '包河区', '肥东县', '肥西县', '长丰县', '庐江县', '巢湖市'] },
	...
	{ name: '黑龙江省', cities: [
		...
		{ name: '伊春市', districts: ['伊美区', '乌翠区', '友好区', '金林区', '铁力市', '嘉荫县', '汤旺县', '丰林县', '大箐山县', '南岔县'] },
		...
		{ name: '大兴安岭地区', districts: ['漠河市', '呼玛县', '塔河县', '加格达奇区'] }
	] },
	{ name: '云南省', cities: [
	...
	{ name: '广西壮族自治区', cities: [
		{ name: '南宁市', districts: ['兴宁区', '青秀区', '江南区', '西乡塘区', '良庆区', '邕宁区', '武鸣区', '横州市', '宾阳县', '上林县', '马山县', '隆安县'] },
		...
		{ name: '玉林市', districts: ['玉州区', '福绑区', '容县', '陆川县', '博白县', '兴业县', '北流市'] },
		...
		{ name: '崇左市', districts: ['江州区', '扶绑县', '宁明县', '龙州县', '大新县', '天等县', '凭祥市'] }
	] },
	{ name: '海南省', cities: [
		...
		{ name: '定安县', districts: ['定安县'] },
		{ name: '屯昌县', districts: ['屯昌县'] },
		{ name: '澄迈县', districts: ['澄迈县'] },
		{ name: '临高县', districts: ['临高县'] },
		{ name: '白沙黎族自治县', districts: ['白沙黎族自治县'] },
		{ name: '昌江黎族自治县', districts: ['昌江黎族自治县'] },
		{ name: '乐东黎族自治县', districts: ['乐东黎族自治县'] },
		{ name: '陵水黎族自治县', districts: ['陵水黎族自治县'] },
		{ name: '保亭黎族苗族自治县', districts: ['保亭黎族苗族自治县'] },
		{ name: '琼中黎族苗族自治县', districts: ['琼中黎族苗族自治县'] }
	] },
	{ name: '内蒙古自治区', cities: [
	...
	{ name: '陕西省', cities: [
		...
		{ name: '咸阳市', districts: ['秦都区', '渭城区', '三原县', '泾阳县', '乾县', '礼泉县', '永寿县', '长武县', '旬邑县', '淳化县', '武功县', '兴平市', '彬州市'] },
	...
	{ name: '台湾省', cities: [
		...
		{ name: '高雄市', districts: ['楠梓区', '左营区', '鼓山区', '三民区', '盐埕区', '前金区', '新兴区', '苓雅区', '前镇区', '旗津区', '小港区'] }
	] },
	{ name: '香港特别行政区', cities: [
		{ name: '香港', districts: ['中西区', '湾仔区', '东区', '南区', '油尖旺区', '深水埗区', '九龙城区', '黄大仙区', '观塘区', '葵青区', '荃湾区', '屯门区', '元朗区', '北区', '大埔区', '沙田区', '西贡区', '离岛区'] }
	] },
	{ name: '澳门特别行政区', cities: [
		{ name: '澳门', districts: ['花地玛堂区', '花王堂区', '望德堂区', '大堂区', '风顺堂区', '嘉模堂区', '路凼填海区', '圣方济各堂区'] }
	] }
]
